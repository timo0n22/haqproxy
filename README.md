...
Этап 5 — Collaborator (VPS: DNS+HTTP OOB-слушатель + клиент), этап 6 —
DOMLogger-инъекция. Схема БД под эти фичи уже заведена в `internal/store`.
